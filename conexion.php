...
while ($fila=mysqli_fetch_assoc($resultados)){
    echo "<hr><fieldset>";
    echo "Nombre: " . ucwords(strtolower($fila["nombres"]))."<br>";
    echo "Apellidos: ".ucwords(mb_strtolower($fila["apellido1"]))." ".ucwords(mb_strtolower($fila["apellido2"]))."<br>";
    echo "Dni: " . $fila["dni"]. "<br>";
    echo "Email: " . mb_strtolower($fila["email"])."<br>";
